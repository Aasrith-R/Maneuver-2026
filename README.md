...
- **Node.js LTS** recommended (**Node 20.x or 22.x**).
  - If you use **Node 25+**, `npm install` may fail (notably during `netlify-cli` postinstall).
...
# (Optional) Run Vite directly (no Netlify dev proxy)
npm run dev:vite
