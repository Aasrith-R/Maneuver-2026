...
import { downloadCsv } from "@/core/lib/data-transfer/jsonToCsv";
    ...
    try {
      ...
      switch (dataType) {
        case 'scouting': {
          ...
          const toCsvCell = (value: unknown): string | number => {
            if (value === null || value === undefined) return '';
            if (typeof value === 'boolean') return value ? 'TRUE' : 'FALSE';
            if (typeof value === 'number') return value;
            if (typeof value === 'string') {
              if (value === '[object Object]' || value === '[object object]') return 0;
              return value;
            }
            return 0;
          };
